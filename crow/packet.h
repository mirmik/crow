...
namespace crow
{
	...
	*/
	...
	struct packet
	{
		...
		[[deprecated]]
		igris::buffer datasect() { return igris::buffer(dataptr(), datasize()); }

		[[deprecated]]
		igris::buffer addrsect() { return igris::buffer(addrptr(), addrsize()); }
...
///
crow::packet* crow_create_packet(struct crow::gateway* ingate, size_t addrsize, size_t datasize);
