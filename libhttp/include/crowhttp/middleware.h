...
namespace crowhttp // NOTE: Already documented in "crowhttp/app.h"
{
    ...
    namespace detail
    {
        ...
        typename std::enable_if<black_magic::CallHelper<F, black_magic::S<Args...>>::value, void>::type
          wrapped_handler_call(crowhttp::request& /*req*/, crowhttp::response& res, const F& f, Args&&... args)
        {
            ...
            res = crowhttp::response(f(std::forward<Args>(args)...));
            res.end();
        }
        ...
        typename std::enable_if<
          !black_magic::CallHelper<F, black_magic::S<Args...>>::value &&
            black_magic::CallHelper<F, black_magic::S<crowhttp::request&, Args...>>::value,
          void>::type
          wrapped_handler_call(crowhttp::request& req, crowhttp::response& res, const F& f, Args&&... args)
        {
            static_assert(!std::is_same<void, decltype(f(std::declval<crowhttp::request>(), std::declval<Args>()...))>::value,
                          "Handler function cannot have void return type; valid return types: string, int, crowhttp::response, crowhttp::returnable");

            res = crowhttp::response(f(req, std::forward<Args>(args)...));
            res.end();
        }
        ...
        typename std::enable_if<
          !black_magic::CallHelper<F, black_magic::S<Args...>>::value &&
            !black_magic::CallHelper<F, black_magic::S<crowhttp::request&, Args...>>::value &&
            black_magic::CallHelper<F, black_magic::S<crowhttp::response&, Args...>>::value,
          void>::type
          wrapped_handler_call(crowhttp::request& /*req*/, crowhttp::response& res, const F& f, Args&&... args)
        {
            static_assert(std::is_same<void, decltype(f(std::declval<crowhttp::response&>(), std::declval<Args>()...))>::value,
        ...
        typename std::enable_if<
          !black_magic::CallHelper<F, black_magic::S<Args...>>::value &&
            !black_magic::CallHelper<F, black_magic::S<crowhttp::request&, Args...>>::value &&
            !black_magic::CallHelper<F, black_magic::S<crowhttp::response&, Args...>>::value &&
            black_magic::CallHelper<F, black_magic::S<const crowhttp::request&, crowhttp::response&, Args...>>::value,
          void>::type
          wrapped_handler_call(crowhttp::request& req, crowhttp::response& res, const F& f, Args&&... args)
        {
            static_assert(std::is_same<void, decltype(f(std::declval<crowhttp::request&>(), std::declval<crowhttp::response&>(), std::declval<Args>()...))>::value,
                          "Handler function with response argument should have void return type");
