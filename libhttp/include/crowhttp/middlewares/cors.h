...
namespace crowhttp
{
    ...
    struct CORSRules
    {
        friend struct crowhttp::CORSHandler;
        ...
        CORSRules& methods(crowhttp::HTTPMethod method)
        {
            add_list_item(methods_, crowhttp::method_name(method));
            return *this;
        }

        /// Set Access-Control-Allow-Methods. Default is "*"
        template<typename... Methods>
        CORSRules& methods(crowhttp::HTTPMethod method, Methods... method_list)
        {
            add_list_item(methods_, crowhttp::method_name(method));
            methods(method_list...);
            return *this;
    ...
    private:
        ...
        void set_header_no_override(const std::string& key, const std::string& value, crowhttp::response& res)
        {
    ...
    struct CORSHandler
    {
        ...
        void before_handle(crowhttp::request& /*req*/, crowhttp::response& /*res*/, context& /*ctx*/)
        {}

        void after_handle(crowhttp::request& req, crowhttp::response& res, context& /*ctx*/)
        {
