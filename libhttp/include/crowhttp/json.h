    ...
    namespace json
    {
        ...
        namespace detail
        {
            ...
            private:
                ...
                friend rvalue crowhttp::json::load(const char* data, size_t size);
        ...
        {
            friend class crowhttp::mustache::template_t;
        ...
        public:
            ...
            static crowhttp::json::wvalue empty_object() { return crowhttp::json::wvalue::object(); }
